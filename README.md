...
Inspiration for the Project: [Mean Daily Temperature Extremes](http://bl.ocks.org/KatiRG/cccd23dd7a830da0de5c) and drive to complete crucial [To-do's](https://github.com/mikelotis/Edmonton-Bylaw-Infractions-I/blob/master/README.md#todos)<br>
...
* [Checked To-do's](https://github.com/mikelotis/Edmonton-Bylaw-Infractions-I/blob/master/README.md#todos) for Dashboard I
## To-do's
...
- [ ] [Unchecked To-do's](https://github.com/mikelotis/Edmonton-Bylaw-Infractions-I/blob/master/README.md#todos) from Dashboard I
