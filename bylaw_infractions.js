document.addEventListener("DOMContentLoaded", function dashboard() {
    //Set up loading spinner
     ...
     queue()
            .defer(d3.json, "https://cdn.rawgit.com/Edmonton-Open-Data/Edmonton-Bylaw-Infractions-II/master/data/Edmonton2.json") //neighbourhoodsGejson
            .defer(d3.json, "https://cdn.rawgit.com/Edmonton-Open-Data/Edmonton-Bylaw-Infractions-II/master/data/data.json")     //datajson
            .await(renderCharts);
